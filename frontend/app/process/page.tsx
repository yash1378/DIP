  ...
  useEffect(() => {
    ...
    if (id) {
      try {
        ...
        const storedImage = localStorage.getItem("process" + id);
        ...
        if (storedImage) {
          ...
          if (parsedImage && parsedImage.startsWith("data:image/")) {
            setImageSrc(parsedImage);
            setError(null);
          } else {
                  ...
                  {imageSrc && (
                    <div style={{ width: "100%", height: "auto" }}>
                      <Image
                        ...
                        width={200}
                        height={300}
                        layout="intrinsic" // Automatically adjust to the intrinsic size of the image
